...
let my_subset_test1 = subset [1;1;1;1] [1;3;1]
let my_subset_test2 = not (subset [0] [])

let my_equal_sets_test0 = equal_sets [] []
let my_equal_sets_test1 = equal_sets [1] [1;1]
let my_equal_sets_test1 = not (equal_sets [1;2] [1])

let my_set_union_test0 = equal_sets (set_union [1;2] []) [1;2]
let my_set_union_test1 = equal_sets (set_union [3;2;3] [3;1;3]) [1;2;3]
...
let my_set_intersection_test1 =
  equal_sets (set_intersection [3;2;3] [3;1;3]) [3]
let my_set_intersection_test2 =
  equal_sets (set_intersection [1;2;3;4;5] [2;3;4]) [2;3;4]

let my_set_diff_test0 = equal_sets (set_diff [1;2;3;4;1] [1;4]) [2;3]
...
let my_computed_fixed_point_test1 =
  computed_fixed_point (=) (fun x -> x / 2) 10000 = 0
...
let my_rle_decode_test1 = 
  equal_sets (rle_decode [1,"s"; 1,"i"; 3,"s"; 2,"z"]) ["s"; "i"; "s"; "s"; "s"; "z"; "z"]
let my_rle_decode_test2 =
  equal_sets (rle_decode [0, 2.00; 2, 0.00]) [0.0; 0.0]
